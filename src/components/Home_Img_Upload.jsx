...
function Home_Img_Upload() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      // const response = await fetch(`http://${getIP()}:9100/home/home_img_upload`, {
      //   method: 'POST',
      //   body: formData
      // });

      const response = await axiosInstance.post(`/home/home_img_upload`, formData,
        {
          headers: {
...
export default Home_Img_Upload;
